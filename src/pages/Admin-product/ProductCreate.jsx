          ...
          <Stack gap={0}>
            <Grid p="sm">
              ...
              <Grid.Col>
                ...
                <Text size="sm">
                  Thêm danh sách hình giới thiệu sản phẩm và chọn hình đại diện
                </Text>
              </Grid.Col>
              <Grid.Col>
              ...
              <Grid.Col>
                ...
                <Text size="sm">
                  Thêm mới thuộc tính giúp sản phẩm có nhiều lựa chọn, như kích
                  cỡ hay màu sắc
                </Text>
              </Grid.Col>
              <Grid.Col>
              ...
              <Grid.Col>
                ...
                <Text size="sm">
                  Phiên bản mặc định của sản phẩm hoặc phiên bản dựa vào thuộc
                  tính sản phẩm
                </Text>
              </Grid.Col>
              <Grid.Col>
