...
const listResponse = {
  content: [
    {
      id: 2,
      createdAt: "2021-08-20T01:29:19Z",
      updatedAt: "2021-07-01T19:52:07Z",
      code: "10812-201",
      exportDocket: {
        id: 3,
    ...
    {
      id: 1,
      createdAt: "2022-07-01T07:16:33Z",
      updatedAt: "2021-12-02T16:53:14Z",
      code: "06420-076",
      exportDocket: {
        id: 1,
      ...
      note: "Excision of Right Lower Leg Tendon, Open Approach",
    },
  ],
  page: 1,
  size: 5,
...
function TransferManage() {
  ...
  const EntityDetailTableRowsFragment = ({ entity }) => (
    <>
      ...
      <Table.Tr>
        <Table.Td>{TransferConfigs.properties["exportDocket.warehouse.name"].label}</Table.Td>
        <Table.Td>{entity.exportDocket.warehouse.name}</Table.Td>
      </Table.Tr>
      <Table.Tr>
        <Table.Td>{TransferConfigs.properties["exportDocket.status"].label}</Table.Td>
        <Table.Td>
          <DocketStatusBadge status={entity.exportDocket.status} />
        </Table.Td>
      </Table.Tr>
      ...
      <Table.Tr>
        <Table.Td>{TransferConfigs.properties["importDocket.warehouse.name"].label}</Table.Td>
        <Table.Td>{entity.importDocket.warehouse.name}</Table.Td>
      </Table.Tr>
      <Table.Tr>
        <Table.Td>{TransferConfigs.properties["importDocket.status"].label}</Table.Td>
        <Table.Td>
          <DocketStatusBadge status={entity.importDocket.status} />
        </Table.Td>
      </Table.Tr>
      <Table.Tr>
        ...
        <Table.Td>{MiscUtils.formatterPrice(entity.exportDocket.docketVariants.length)} SKU</Table.Td>
      </Table.Tr>
      <Table.Tr>
