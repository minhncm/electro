...
import CustomerResourseCreate from "~/pages/Admin-customer-resource/CustomerResourceCreate";
import CustomerResourseUpdate from "~/pages/Admin-customer-resource/CustomerResourceUpdate";
...
import DestinationManage, {
  DestinationCreate,
  DestinationUpdate,
} from "~/pages/Admin-destination";
...
import GuaranteeManage, {
  GuaranteeCreate,
  GuaranteeUpdate,
} from "~/pages/Admin-guarantee";
...
import SpecificationManage, {
  SpecificationCreate,
  SpecificationUpdate,
} from "~/pages/Admin-specification";
...
import TransferManage, {
  TransferCreate,
  TransferUpdate,
} from "~/pages/Admin-transfer";
...
import DocketReasonManage, {
  DocketReasonCreate,
  DocketReasonUpdate,
} from "./pages/Admin-docket-reason";
import PurchaseOrderManage, {
  PurchaseOrderCreate,
  PurchaseOrderUpdate,
            ...
            <div className="App">
              <Routes>
                <Route path="/" element={<Client />}>
                  ...
                  <Route
                    path="/user/setting/personal"
                    element={<ClientSettingPersonal />}
                  />
                  <Route
                    path="/user/setting/phone"
                    element={<ClientSettingPhone />}
                  />
                  <Route
                    path="/user/setting/email"
                    element={<ClientSettingEmail />}
                  />
                  <Route
                    path="/user/setting/password"
                    element={<ClientSettingPassword />}
                  />
                  <Route
